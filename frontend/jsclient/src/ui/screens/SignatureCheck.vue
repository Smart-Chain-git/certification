                            ...
                            <v-expansion-panel class="more_info">
                                ...
                                <v-expansion-panel-content class="pt-4">
                                    <div v-if="checkResponse.check_status === 1">
                                        ...
                                        <span v-html="parseLink('signatureCheck.success.message1.block2.line7', {'href' : this.storageURL})"/>
                                    </div>
                                    <div v-if="checkResponse.check_status === 2">
                                        ...
                                        <span v-html="parseLink('signatureCheck.success.message2.block2.line10', 'here', {'href' : this.storageURL})"/>
                                    </div>
...
export default class SignatureCheck extends Vue {
    ...
    private get proofURL(): string {
        const blob = new Blob([JSON.stringify(this.checkResponse?.proof)],
